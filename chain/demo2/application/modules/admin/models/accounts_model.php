...
// Get all accounts active customers
    ...
    function update_profile($actype, $id, $filename = null) {
        ...
        $data1 = array('ai_title' => $this->input->post('title'), 'ai_first_name' => $this->input->post('fname'), 'ai_last_name' => $this->input->post('lname'),
...
// Add New Account
    function add_account($filename = null) {
        ...
        $data = array('accounts_email' => $this->input->post('email'), 'accounts_password' => sha1($this->input->post('password')), 'accounts_type' => $type, 'accounts_is_admin' => $isadmin, 'ai_title' => $this->input->post('title'), 'ai_first_name' => $this->input->post('fname'), 'ai_last_name' => $this->input->post('lname'), 'ai_dob' => $this->input->post('dob'), 'ai_city' => $this->input->post('city'), 'ai_country' => $this->input->post('country'), 'ai_state' => $this->input->post('state'), 'ai_address_1' => $this->input->post('address1'), 'ai_address_2' => $this->input->post('address2'), 'ai_mobile' => $this->input->post('mobile'), 'ai_fax' => $this->input->post('fax'), 'ai_postal_code' => $this->input->post('postal_code'), 'ai_passport' => $this->input->post('passport'), 'ai_website' => $this->input->post('website'), 'ai_image' => $filename, 'accounts_created_at' => $now, 'accounts_updated_at' => $now, 'accounts_status' => $this->input->post('status'), 'accounts_permissions' => $permissions);
...
// Add New supplier from fornt end register page
    function register_supplier() {
        ...
        $password = rand(5, 15);
        $data = array('accounts_email' => $this->input->post('email'), 'accounts_password' => $password, 'accounts_type' => "supplier", 'accounts_is_admin' => 0, 'ai_title' => $this->input->post('title'), 'ai_first_name' => $this->input->post('fname'), 'ai_last_name' => $this->input->post('lname'), 'ai_city' => $this->input->post('city'), 'ai_country' => $this->input->post('country'), 'ai_state' => $this->input->post('state'), 'ai_address_1' => $this->input->post('address1'), 'ai_address_2' => $this->input->post('address2'), 'ai_mobile' => $this->input->post('mobile'),
//  'ai_image' => $filename,
...
// Admin login
    function login_admin($username, $password) {
        ...
        $this->db->select('accounts_email,accounts_password,accounts_id,accounts_type,ai_first_name,ai_last_name,client_id');
        ...
        if ($num > 0) {
			...
			$this->session->set_userdata('client',$this->theme->_getClientType($user[0]->client_id));
			$this->session->set_userdata('client_id',$user[0]->client_id);
...
// Signup account
    function signup_account($type, $status) {
        ...
        $data = array('accounts_email' => $this->input->post('email'), 'accounts_password' => sha1($password), 'accounts_type' => $type, 'ai_title' => $this->input->post('title'), 'ai_first_name' => $this->input->post('firstname'), 'ai_last_name' => $this->input->post('lastname'),'ai_address_1' => $address, 'ai_city' => $city, 'ai_country' => "", 'ai_mobile' => $this->input->post('phone'), 'accounts_created_at' => $now, 'accounts_updated_at' => $now,'accounts_verified' => $verified, 'accounts_status' => $status);
        $this->db->insert('pt_accounts', $data);
