...
class Uploads_model extends CI_Model {
 ...
 /*		if($width > 250){
      ...
      $this->settings_model->update_watermark_img($filename);
 ...
 // upload profile picture
	...
	/*end __sliderimg() */
        ...
        // upload Country Image and Add Update country

	function __countryimg($id = null)
	{
       ...
       // $m = "1";
		...
		$savefile = PT_FLAG_IMAGES_UPLOAD.$fig.$filename;
		...
		$filename_db = $fig.$filename;
       	...
       	$this->countries_model->addcountry($filename_db);


        }else{

         	$this->countries_model->updatecountry($id,$filename_db);
        }
