    ...
    <div class="menu">
      <div class="menu-content">
        <ul id="social-sidebar-menu">
          ...
          <!-- BEGIN ELEMENT MENU-->
          <li>
            <a href="#CMS" data-toggle="" data-parent="#social-sidebar-menu">
              <!-- icon--><i class="fa fa-list-alt"></i>
              <span><?php echo trans('013');?></span>
              <!-- arrow--><i class="fa arrow"></i>
            </a>
            <!-- BEGIN SUB-ELEMENT MENU-->
            <ul id="CMS" class=" wow fadeIn animated">
              <li>
          ...
          <?php $moduleslist = $this->ptmodules->read_config();
            ...
            if(pt_permissions($modl['Name'],@$userloggedin)){
             if($modl['isIntegration'] != "Yes"){
             	(strtolower($modl['DisplayName'])=="hotels")?$displayName="Hotels Setup":$displayName=$modl['DisplayName'];
            ?>
          <li class="open">
            ...
            <ul id="<?php echo $modl['DisplayName']; ?>" class="collapse in wow fadeIn animated">
              <?php echo str_replace("%baseurl%","$baseurl",$submenu); ?>
              <?php
              if(strtolower($modl['DisplayName'])=="hotels"){
              	#echo '<li><a href="#">Update Allotments</a></li>';
              }
              ?>
            </ul>
          </li>
          ...
          ?>
           <li class="open">
            <a href="#rates" data-toggle="collapse" data-parent="#social-sidebar-menu">
            <i class="fa fa-calendar"></i>
            <span>Rates & Allotments </span>
            <i class="fa arrow"></i>	
            </a>
            <ul id="rates" class="wow fadeIn animated collapse in">
             <li><a href="<?=$base;?>/hotels/listrates">Setup Rate</a></li>
             <li><a href="<?=$base;?>/hotels/listrates">Update Rate</a></li>
            </ul>
          </li>
          <li>
          ...
          <li>
            <a href="#promotion" data-toggle="collapse" data-parent="#social-sidebar-menu">
            <i class="fa fa-bullhorn"></i>
            <span>Promotions</span>
            <i class="fa arrow"></i>	
            </a>
            <ul id="promotion" class="wow fadeIn animated collapse">
          ...
          <?php if(pt_permissions('booking',@$userloggedin)){ ?>
           <li>
            ...
            <span><?php echo "Reservation";#trans('034');?></span><span class="pull-right label label-danger" id=""></span>
            </a>
          </li>
          <?php } ?>
          <li>
            <a href="#manual" data-toggle="collapse" data-parent="#social-sidebar-menu">
