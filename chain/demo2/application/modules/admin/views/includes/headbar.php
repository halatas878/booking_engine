      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li>
        	<form action="<?=__CUURENT_URL__;?>" method="get">
		 	<div class="rown input-group pull-right" id="adv-search" style="top:3px;">
        ...
        <li class="dropdown">
          <a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="0" class="dropdown-toggle"><i class="fa fa-caret-down fa-lg"></i> Hai, <?php echo $this->session->userdata('fullName');?>
          </a>
