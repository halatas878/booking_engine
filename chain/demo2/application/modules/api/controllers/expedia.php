...
*/
		function listMore_get() {
				...
				$str = $this->apiurl . "list?minorRev=" . $this->rev . "&cid=" . $this->cid . "&apiKey=" . $this->apiKey . "&customerUserAgent=" . $this->customerUserAgent . "customerIpAddress=" . $this->customerIpAddress . "&customerSessionId=" . $customerSessionId . "&locale=" . $this->local . "&currencyCode=" . $this->currency . "&cacheKey=" . $cacheKey . "&cacheLocation=" . $cacheLocation;
				$this->apistr = $str;
                $this->response($this->apiCall($str), 200);
		}
