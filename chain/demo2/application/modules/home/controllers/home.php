...
class Home extends MX_Controller {
		...
		function __construct() {
				...
				$this->ismobile = ($this->mobiledetection->isMobile());
				#echo "<pre/>";print_r($this->theme->_getClientType());exit();
				...
				if ($pageslug == null || $this->validlang && empty($secondslug)) {
                        ...
                        if (pt_main_module_available('hotels')) {
					        ...
					        //	$this->data['latest_hotels'] = $this->hotels_model->latest_hotels_front();
                             ...
                             $hotels =   $this->data['featuredHotels'] = $this->hotels_lib->getFeaturedHotels($this->ismobile);
								#echo "<pre/>";print_r($this->ismobile);exit();
					        ...
					        //	$this->data['mini_hero_hotels'] = $this->hotels_lib->mini_hero_hotels_list();
								$this->data['reviews'] = $this->hotels_lib->hotelReviews('',3);
								#$this->data['avgReviews'] = $this->hotels_lib->hotelReviewsAvg();
								#echo "<pre/>";print_r($this->data['reviews']);exit();
								$this->data['video'] = $this->hotels_model->getVideo();
								$this->listing();
						}
#if(isset($_GET['debug'])){ echo "<pre/>";print_r($this->data['hotelslocationsList']);exit();}
...
//   }
        ...
        $allposts = $this->blog_lib->show_posts(0,3);
        ...
        $this->data['langurl'] = base_url()."blog/{langid}/";
			#echo "<pre/>";print_r($allposts['all_posts']['all']);exit('as');
	    }
