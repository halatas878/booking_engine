...
Dropzone.options.dropzone = {
 ...
 <h1 class="title"><i class="fa fa-file-image-o"></i> Galery</h1>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                           ...
                           <tr  id="tr_<?php echo $img->id;?>">
                               ...
                               <a href="<?php echo $thumbsDir.$img->image;?>" rel=""> <img src="<?php echo $thumbsDir.$img->image;?>" href="<?php echo $fullImgDir.$img->image;?>" class="img-responsive colorbox" style="width:200px;"></a>
