...
<form action="" method="POST" class="hotel-form" enctype="multipart/form-data" onsubmit="return false;" >
  <div class="panel panel-default">
    <ul class="nav nav-tabs nav-justified" role="tablist">
      ...
      <li class=""><a href="#META_INFO" data-toggle="tab">SEO</a></li>
    ...
    <div class="panel-body">
      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <select data-placeholder="Select" class="form-control" name="hotelstatus">
                <option value="yes" <?php if(@$hdata[0]->hotel_status == "yes"){ echo "selected"; }?> >Publish</option>
                <option value="no" <?php if(@$hdata[0]->hotel_status == "no"){ echo "selected"; }?> >UnPublish</option>
              </select>
            </div>
          </div>
          <div class="row form-group">
          ...
          <div class="row form-group">
            <label class="col-md-2 control-label text-left text-danger">Service charge & tax</label>
            <div class="col-md-2">
