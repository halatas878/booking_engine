            ...
            <div class="tab-content form-horizontal">
                <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                  <input class="form-control input-lg" type="text" placeholder="Type name here" name="roomname" value="<?php echo @$rdata[0]->room_title;?>" >
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <label class="col-md-2 control-label text-left">Master Rates</label>
                        <div class="col-md-2">
								 <input class="form-control" Placeholder="Price" type="number" name="basicprice" value="<?php echo @$rdata[0]->room_basic_price;?>" />
                        </div>
                     </div>
                     <div class="row form-group">
                        <label class="col-md-2 control-label text-left">Allotments</label>
                        <div class="col-md-2">
