<h1 class="margin-top-0 title"><i class="fa fa-home"></i> <?=(!isset($_GET['general']))?"Setting":"Home Page";?></h1>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="tab-content form-horizontal">
        ...
        <?php endif; if(!isset($_GET['general'])):?>
        <div class="tab-pane wow fadeIn animated active in" id="HOTELS_TYPES">
          <div class="add_button_modal" style="margin-top:0 !important;"> <button type="button" data-toggle="modal" data-target="#ADD_HOTELS_TYPES" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add</button></div>
          <?php echo $contenthtypes; ?>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="ROOMS_TYPES">
          <div class="add_button_modal"  style="margin-top:0 !important;"> <button type="button" data-toggle="modal" data-target="#ADD_ROOM_TYPES" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add</button></div>
          <?php echo $contentrtypes; ?>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="PAYMENT_METHODS">
          <div class="add_button_modal" style="margin-top:0 !important;" > <button type="button" data-toggle="modal" data-target="#ADD_PAYMENT_TYPES" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add</button></div>
          <?php echo $contenthpayments; ?>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="HOTELS_AMENITIES">
          <div class="add_button_modal" style="margin-top:0 !important;" > <button type="button" data-toggle="modal" data-target="#ADD_HOTEL_AMT" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add</button></div>
          <?php echo $contenthamenities; ?>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="ROOMS_AMENITIES">
          <div class="add_button_modal" style="margin-top:0 !important; " > <button type="button" data-toggle="modal" data-target="#ADD_ROOM_AMT" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add</button></div>
