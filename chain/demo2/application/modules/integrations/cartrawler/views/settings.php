<script>
  ...
  <form action="" method="POST">
    ...
    <div class="panel-heading">
      <span class="panel-title pull-left">Cartrawler Settings</span>
            ...
            <div class="panel-body">
             ...
             <div class="form-horizontal  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                      ...
                      <tr>
                       <td>Cartrawler Client ID</td>
                      <td>
                      <input type="" class="form-control" name="username" placeholder="Client ID" value="<?php echo $settings[0]->cid;?>" />
                      </td>
                      <td>Input your Client ID here</td>
                      </tr>

                      <tr>
                       <td>Default Currency</td>
                      <td>
                      <input type="" class="form-control" name="currency" placeholder="Default Currency" value="<?php echo $settings[0]->currency;?>" />
                      </td>
                      <td>Input Default currency to be used.</td>
                      </tr>
                      ...
                      <td>URL</td>
                      <td>
                      <input type="text" name="url" class="form-control" placeholder="url" value="<?php echo $settings[0]->secret;?>" />
                      </td>
                      <td>Write cartrawler url here for fetching data</td>
                      </tr>
    ...
    <input type="hidden" name="updatefor" value="cartrawler" />
