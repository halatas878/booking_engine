...
<html>
  <head>
    ...
    <?php
    if($client_themes->type=="chain"){ 
    	echo '<link href="'.base_url().'assets/css/custom.css?'.time().'" rel="stylesheet" media="screen">';
    }else{
    	echo '<link href="'.$theme_url.'assets/css/custom-single.css?'.time().'" rel="stylesheet" media="screen">';
    }
    ?>
  ...
  <body id="top">
    <!-- Top wrapper -->
    <div class="<?=($client_themes->theme['header']=="full")?"container-full shaddow":"";?> navbar navbar-fixed-top navbar-default <?php echo @$hidden; ?>">
      <div class="container <?=($client_themes->theme['header']=="box")?"shaddow ":"";?>  pl0 pr0">
        <div class="navbar">
            <!-- Navigation-->
            <div class="navbar-header go-right">
              ...
              <a href="<?=base_url(); ?>" class="navbar-brand"><img src="<?=PT_GLOBAL_IMAGES_FOLDER.$app_settings[0]->header_logo_img;?>" alt="<?=$app_settings[0]->site_title;?>" class="moto"/></a>
            </div>
