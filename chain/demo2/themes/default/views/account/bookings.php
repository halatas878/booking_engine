...
<div class="row">
  ...
  <div class="col-md-2 offset-0">
    <a style="margin-bottom:5px" href="<?php echo base_url();?>invoice?id=<?php echo $b->id;?>&sessid=<?php echo $b->code;?>" target="_blank" class="btn btn-search5 btn-block"><?php echo trans('076');?></a>
    <?php if($b->status == "paid"){ ?> <span class="btn btn-primary btn-block" data-toggle="modal" href="#AddReview<?php echo $b->id;?>" class="btn_3"><?php if($b->reviewsData['reviewGiven'] == "yes"){ echo trans("0391"); }else{ echo trans('083');?></span><?php } } ?>
  </div>
...
<?php if(!empty($eanbookings)){ // print_r($eanbookings);
  ...
  <div class="col-md-5 offset-0">
    ...
    <span class="opensans green bold size14"><strong><?php echo $eanbook->total;?> </strong></span> - <small><span class="grey"><?php echo $eanbook->checkin;?></span></small><br>
  </div>
  <div class="col-md-3">
    <span class="grey">
      <strong><?php echo trans('0145');?> <?php echo trans('021');?></strong> <?php echo $eanbook->id;?>><br>
      <strong><?php echo trans('0398');?> </strong> <?php echo $eanbook->code;?> <br>
  ...
  <div class="col-md-2 offset-0">
    <a style="margin-bottom:5px" href="<?php echo base_url();?>invoice?eid=<?php echo $eanbook->id;?>&sessid=<?php echo $eanbook->code;?>" target="_blank" class="btn btn-search5 btn-block"><?php echo trans('076');?></a>
        <?php if($b->status == "paid"){ ?> <span data-toggle="modal" href="#AddReview<?php echo $b->id;?>" class="btn btn-primary btn-block"><?php if($b->reviewsData['reviewGiven'] == "yes"){ echo trans("0391"); }else{ echo trans('083');?></span><?php } } ?>
  </div>
  <div class="clearfix"></div>
  <div class="line2"></div>
</div>
