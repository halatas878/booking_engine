  ...
  <div class="col-md-12">
    ...
    <div class="tabsbar">
        <ul class="RTL visible-lg visible-md nav nav-tabs nav-justified">
          ...
          <?php if(!empty($car->desc)){ ?><li class="text-center"><a class="tabsBtn" href="#DESCRIPTION" data-toggle="tab"><?php echo trans('046');?></a></li><?php  } ?>
          <?php if(!empty($car->relatedCars)){ ?><li class="text-center"><a class="tabsBtn" href="#RELATED" data-toggle="tab"><?php echo trans('0493');?></a></li><?php  } ?>
        </ul>
    </div>
