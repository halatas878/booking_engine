                ...
                <table class="table table_summary">
                  <tbody>
                    ...
                    <tr class="beforeExtraspanel">
                      ...
                      <td class="text-right">
                        <?php echo $room->currCode;?> <?php echo $room->currSymbol;?><span id="displaytax"><?php echo $hotel->taxAmount;?></span>
                      </td>
                    </tr>
                    <div class="booking-deposit">
                      <tr>
                        ...
                        <td class="text-right">
                          <strong><span class="booking-deposit-font go-left"><?php echo $room->currCode;?> <?php echo $room->currSymbol;?><span id="displaydeposit"><?php echo $hotel->depositAmount?></span></span></strong>
                        </td>
                      </tr>
                    </div>
                    <tr>
