    ...
    <div class="modal-body">
      ...
      <div class="center-block">
         <center>
          ...
          <p><strong><?php echo trans('0309'); ?></strong> : <?php echo strip_tags($nonRefundable); ?></p>
          <?php } ?>
        </center>
      </div>
...
<?php  }else{ ?>
<form  style="background: #f9f9f9 !important;" role="form" action="" method="POST">
    ...
    <div class="acc_section">
      ...
      <!--End step -->
          ...
          <!-- End Complete This booking button only -->
                ...
                <input type="hidden" name="affiliateConfirmationId" value="<?php echo $affiliateConfirmationId; ?>" />
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <span id="waiting"></span>
                <button type="submit" class="btn btn-success btn-lg btn-block paynowbtn" onclick="return expcheck();" name="<?php if(empty($usersession)){ echo "guest";}else{ echo "logged"; } ?>"  onclick="return completebook('<?php echo base_url();?>','<?php echo trans('0159')?>');"><?php echo trans('0306');?></button>
            <br>
    ...
    <div class="col-md-4 go-left" style="margin-bottom: 40px;">
     <div class="pagecontainer2 paymentbox grey">
      ...
      <div class="hpadding30">
        ...
        <span class="right lred2 bold size18">  <?php echo $currency." ".$total; ?> <span style="font-size: 9px !important; color: #000 !important;"> (Including Taxes and Fees) </span> </span>
        <div class="clearfix"></div>
        </div>
