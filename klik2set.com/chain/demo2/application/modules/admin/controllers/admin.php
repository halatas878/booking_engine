...
// hotels module controller
		function hotels($args = null, $id = null, $roomid = null) {
                ...
                elseif ($args == "manage") {
						...
						$hotelsmod->contact();
				}elseif ($args == "analytics") {
						$hotelsmod->analytics();
				}elseif ($args == "promotions") {
						$hotelsmod->promotions($this->uri->segment(4));
				}elseif ($args == "listrates") {
						$hotelsmod->listrates();
				}elseif ($args == "setuprates") {
						$hotelsmod->setuprates();
				}elseif ($args == "updaterates") {
						$hotelsmod->updaterates();
				}elseif ($args == "newrates") {
						$hotelsmod->newrates();
				}elseif ($args == "cancelations") {
						$hotelsmod->cancelations();
				}elseif ($args == "extras") {
						$hotelsmod->extras($id);
				}elseif ($args == "reviews") {
