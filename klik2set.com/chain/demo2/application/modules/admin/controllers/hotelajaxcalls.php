...
// update Videos order
		...
		public function update_video_order() {
				...
				$order = $this->input->post('order');
				$this->hotels_model->update_video_order($vid, $order);
		}
...
<br>';
						...
						echo '
<div class="alert alert-success"><i class="fa fa-check-square-o"></i> Link Added Successfully.</div>
<br>';
				}
		}
...
// Delete Room Prices
		...
		function deleteCancel(){
		  $id = $this->input->post('id');
          $this->hotels_model->deleteCancel($id);
		}
		
		function deletePromotion(){
		  $id = $this->input->post('id');
          $this->hotels_model->deletePromotion($id);
		}
