<?php
          ...
          function do_booking($userid) {
              ...
              if ($bookingtype == "hotels") {
                ...
                $pickupdate = $this->input->post('pickupDate');
                  ...
                  $bookingData = json_decode($this->cars_lib->getUpdatedDataBookResultObject($itemid,$extras,$pickup,$drop));
                  $error = false;    
              }
             ...
             // $grandtotal = $this->currconverter->convertPriceFloat($bookingData->grandTotal);
              $grandtotal = $this->currconverter->removeComma($bookingData->grandTotal, 0);
              ...
              $deposit = $this->currconverter->removeComma($bookingData->depositAmount,0);
              $tax = $this->currconverter->removeComma($bookingData->taxAmount,0);
              $paymethodfee = 0;
      //$this->currconverter->convertPriceFloat($bookingData->paymethodFee);
              $extrasTotalFee = $this->currconverter->removeComma($bookingData->extrasInfo->extrasTotalFee, 0);
              ...
              $extrabedscharges = $this->currconverter->removeComma($bookingData->extraBedCharges, 0);
      ...
      //    'booking_payment_type' => $paymethod,
                  ...
                  elseif ($bookingtype == "cars") {
                      $cdata = array('booked_booking_id' => $bookid, 'booked_car_id' =>  $itemid, 'booked_pickupdate' => convert_to_unix($pickupdate), 'booked_pickuptime' => $pickuptime, 'booked_pickuplocation' => $pickup, 'booked_dropofflocation' => $drop, 'booked_booking_status' => 'unpaid');
