...
<div class="row">
  <div class="col-md-7 go-right">
    <h2 class="go-right"><strong><?php echo character_limiter($hotel->title, 28);?></strong></h2>
    <div class="clearfix"></div>
    <h4 class="go-right RTL"><i class="icon-location-6"></i> <?php echo $hotel->location; ?> <?php echo $hotel->stars;?></h4>
  </div>
  <div class="col-md-5">
    <div class="row">
      <?php if($hasRooms){ ?>
