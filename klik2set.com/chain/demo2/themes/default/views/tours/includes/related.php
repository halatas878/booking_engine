<?php if(!empty($tour->relatedTours)){ ?>
<div id="RELATED" class="lastminute4">
  <div class="container cstyle04">
    <div class="row anim3">
      <div class="col-md-3 visible-lg visible-md go-right">
        <h2 class="go-right"><?php echo trans('0453');?></h2>
        <div class="clearfix"></div>
        <hr style="border-top: 1px solid #DADADA;">
        <a href="<?php echo base_url(); ?>hotels" class="btn iosbtn go-right"><?php echo trans('0466');?> <?php echo trans('Tours');?></a>
        <div class="clearfix"></div>
      </div>
      <div class="col-md-9 col-sm-12 go-left">
        ...
        <div class="wrapper">
          <div class="list_carousel">
            <ul id="foo2">
              <?php foreach($tour->relatedTours as $item){ ?>
              <li>
