<?php if(!empty($car->relatedCars)){ ?>
<div id="RELATED" class="lastminute4">
  <div class="container cstyle04">
    <div class="row anim3">
      <div class="col-md-3 visible-lg visible-md go-right">
        <h2 class="go-right"><?php echo trans('0493');?></h2>
        <div class="clearfix"></div>
        <hr style="border-top: 1px solid #DADADA;">
        <a href="<?php echo base_url(); ?>cars" class="btn iosbtn go-right"><?php echo trans('0466');?> <?php echo trans('Cars');?></a>
        <div class="clearfix"></div>
      </div>
