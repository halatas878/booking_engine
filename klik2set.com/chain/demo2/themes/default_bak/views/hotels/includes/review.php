 <!-- End row -->
  ...
  <div class="panel-body">
      ...
      <form class="form-horizontal row" method="POST" id="reviews-form-<?php echo $hotel->id;?>" action="" onsubmit="return false;">
        <div id="review_result<?php echo $hotel->id;?>" >
        </div>
        <div class="alert resp" style="display:none"></div>
        <div class="col-md-4 go-right">
        <div class="well well-sm">
          <h3 class="text-center"><strong><?php echo trans('0389');?></strong>&nbsp;<span id="avgall_<?php echo $hotel->id; ?>"> 1</span> / 10</h3>
          <div class="row">
            <div class="col-md-6 form-horizontal">
              <div class="form-group">
                ...
                <label class="control-label"><?php echo trans('030');?></label>
                  <select class="input-sm form-control reviewscore reviewscore_<?php echo $hotel->id; ?>" id="<?php echo $hotel->id; ?>" name="reviews_clean">
              ...
              <div class="form-group">
                ...
                <label class="control-label"><?php echo trans('031');?></label>
                  <select class="input-sm form-control reviewscore reviewscore_<?php echo $hotel->id; ?>" id="<?php echo $hotel->id; ?>" name="reviews_comfort">
                    <option value="1"> 1 </option>
                    <option value="2"> 2 </option>
                    <option value="3"> 3 </option>
                    <option value="4"> 4 </option>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <select class="input-sm form-control reviewscore reviewscore_<?php echo $hotel->id; ?>" id="<?php echo $hotel->id; ?>" name="reviews_location">
                    <option value="1"> 1 </option>
                    <option value="2"> 2 </option>
                    <option value="3"> 3 </option>
                    <option value="4"> 4 </option>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <label class="control-label"><?php echo trans('033');?></label>
                  <select class="input-sm form-control reviewscore reviewscore_<?php echo $hotel->id; ?>" id="<?php echo $hotel->id; ?>" name="reviews_facilities">
                    <option value="1"> 1 </option>
                    <option value="2"> 2 </option>
                    <option value="3"> 3 </option>
                    <option value="4"> 4 </option>
              ...
              <div class="form-group">
                ...
                <label class="control-label"><?php echo trans('034');?></label>
                  <select class="input-sm form-control reviewscore reviewscore_<?php echo $hotel->id; ?>" id="<?php echo $hotel->id; ?>" name="reviews_staff">
                    <option value="1"> 1 </option>
                    <option value="2"> 2 </option>
                    <option value="3"> 3 </option>
                    <option value="4"> 4 </option>
              ...
              <div class="form-group">
                ...
                <label class="control-label">&nbsp;</label>
                  <button type="button" class="btn-sm btn btn-primary btn-block btn-lg addreview" id="<?php echo $hotel->id; ?>" ><?php echo trans('086');?></button>
                </div>
              </div>
            </div>
          </div>
