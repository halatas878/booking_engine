...
<html lang="en">
    ...
    <body >
        <div id="wrapper">
             <iframe style="margin-top:-30px" id="tree" name="tree" src="//whitelabel.dohop.com/w/<?php echo $username;?>" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" scrolling="auto"></iframe>
        </div>
    </body>
</html>