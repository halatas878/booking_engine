...
<div class="container pagecontainer offset-0">
  <form class="panel-body" action="<?php echo base_url();?>tours/search" method="GET">
    ...
    <div class="col-md-2 col-sm-6 col-xs-6 go-right">
      <div class="form-group">
        ...
        <select class="form-control mySelectBoxClass" name="type" id="tourtype" required>
          <option value=""> <?php echo trans('0158');?></option>
          <?php echo $selectedTourType;?>
        </select>
      </div>
    </div>
    <div class="col-md-2 col-sm-6 col-xs-6 go-right">
    ...
    <div class="col-md-2 col-lg-1 col-sm-6 col-xs-6 go-right">
      <div class="form-group">
        <div class="clearfix"></div>
        <label class="control-label go-right size12"><i class="icon-user-7"></i> <?php echo trans('0446');?></label>
    ...
    <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12 go-right">
      <div class="form-group">
        <div class="clearfix"></div>
  ...
  <div class="clearfix"></div>
  <form  action="<?php echo base_url();?>tours/search" method="GET" role="search">
    <!-- FILTERS -->
    <div class="col-md-3 filters offset-0 go-right">
      ...
      <?php echo trans('0366');?> <span class="collapsearrow"></span>
      </button>
  ...
  <div class="rightcontent col-md-9 offset-0">
    <div class="itemscontainer offset-1">
      <?php if(!empty($tours)){ foreach($tours as $item){ ?>
      <div class="offset-2">
        <div class="col-lg-4 col-md-4 col-sm-4 offset-0 go-right">
          <span><?php echo wishListInfo("tours", $item->id); ?></span>
          <div class="img_list">
        ...
        <div class="col-md-8 offset-0">
          <div class="itemlabel3">
            <div class="labelright go-left" style="min-width:105px;margin-left:5px">
              ...
              <span class="size11 grey"><?php echo trans('0367');?></span>
              <br/>
              <div class="clearfix"></div>
              <hr>
              <?php } ?>
            ...
            <div class="labelleft2 rtl_title_home">
              ...
              <a class="go-right" href="javascript:void(0);" onclick="showMap('<?php echo base_url();?>home/maps/<?php echo $item->latitude; ?>/<?php echo $item->longitude; ?>/tour/<?php echo $item->id;?>','modal');" title="<?php echo $item->location;?>"><i style="margin-left: -3px;" class="icon-location-6 go-right"></i><?php echo character_limiter($item->location,10);?></a> <span class="go-right"><?php echo $item->stars;?></span>
              <br><br>
