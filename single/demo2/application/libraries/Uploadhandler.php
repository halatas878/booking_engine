...
class Uploadhandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'admin/hotels/do_upload',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/tests/',
            'upload_url' => $this->get_full_url().'/uploads/tests/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
