    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <!--   <button class="btn btn-success createbackup pull-right"> Create Backup</button> -->
    ...
    if (!empty ($bkups)) {
      foreach ($bkups as $bk) {
        ...
        <div class="col-md-3 btn">
          <div class="list-group-item active clock">
            <button type="button" class="btn btn-default btn-block">
              <h2 class="text-center"><strong><i class="fa fa-download"></i> <a style="color:#000" href="<?php echo base_url();?>admin/backup/download/?backup=<?php echo $bk;?>">Download</a></strong></h2>
            </button>
            <h5 class="text-center"><strong><?php echo date("F j, Y H:i:s", $info['date']);?> </strong></h5>
            <h5 class="text-center del_backup" id="<?php echo $bk;?>"><i class="fa fa-times"></i> <span style="color:#fff">Delete</span></h5>
          </div>
        </div>
        <?php }}else {?>
