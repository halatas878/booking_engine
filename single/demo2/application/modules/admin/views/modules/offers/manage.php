            ...
            <div class="tab-content form-horizontal">
                <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="row form-group">
                        <label class="col-md-2 control-label text-left">Offer Price</label>
                        <div class="col-md-2">
                            <input name="offerprice" type="text" placeholder="Offer Price" class="form-control" value="<?php echo @$offerdata[0]->offer_price;?>" />
                        </div>
                    </div>

                                    <div class="row form-group">
                        <label class="col-md-2 control-label text-left">Availability</label>
                        <div class="col-md-2">
