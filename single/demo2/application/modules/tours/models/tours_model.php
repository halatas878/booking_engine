		...
		function add_tour($user = null) {
			if(empty($user)){
				...
				$data = array('tour_title' => $this->input->post('tourname'), 
					...
					'tour_stars' => $this->input->post('tourstars'), 
					'tour_is_featured' => $this->input->post('isfeatured'), 
					...
					'tour_max_adults' => $this->input->post('maxadult'), 
					'tour_max_child' => $this->input->post('maxchild'), 
					'tour_max_infant' => $this->input->post('maxinfant'), 
					'tour_adult_price' => $this->input->post('adultprice'), 
					'tour_child_price' => $this->input->post('childprice'), 
					'tour_infant_price' => $this->input->post('infantprice'), 
					'adult_status' => $this->input->post('adultstatus'), 
					'child_status' => $this->input->post('childstatus'), 
					'infant_status' => $this->input->post('infantstatus'), 
					'tour_days' => $this->input->post('tourdays'), 
					'tour_nights' => $this->input->post('tournights'), 
