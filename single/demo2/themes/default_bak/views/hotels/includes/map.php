      ...
      <script>
        ...
        if (!Array.prototype.forEach)
        	...
        	markersData = {
        		'marker': [
        		{
        			name: '<?php echo character_limiter($hotel->title, 80);?>',
        			location_latitude: <?php echo $hotel->latitude;?>,
        			location_longitude: <?php echo $hotel->longitude;?>,
        			map_image_url: '<?php echo $hotel->thumbnail;?>',
        			name_point: '<?php echo character_limiter($hotel->title, 80);?>',
        			description_point: '<?php echo character_limiter($hotel->desc, 100);?><br>',
        			url_point: '<?php echo $hotel->slug;?>'
        		},
